...
#MCSRV=minecraft_server.jar
#MCSRV=craftbukkit-1.12.1.jar
#MCSRV=craftbukkit-1.14-R0.1-SNAPSHOT.jar 
#MCSRV=craftbukkit-1.14.1-R0.1-SNAPSHOT.jar
#MCSRV=craftbukkit-1.14.4-R0.1-SNAPSHOT.jar 
#MCSRV=craftbukkit-1.15.2.jar
#MCSRV=paper-1.15.2-213.jar
MCSRV=paper-283.jar
JXMS=2048M
JXMX=2048M
GUI=nogui
...
#Backup vars
TMPDIR=/home/minecraft/server_backup
BCKSRV=lancelot@192.168.10.150
BCKDIR=/home/lancelot/mc_back
